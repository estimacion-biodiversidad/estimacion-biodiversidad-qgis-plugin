...
Después de ejeutar el comando, para ver el nuevo complemento en el menú de QGIS, debe cerrarse el programa y abrirse nuevamente. El complemento debe estar en el menú ```Complementos``` y sus íconos deben ser visibles en la barra de herramientas.
